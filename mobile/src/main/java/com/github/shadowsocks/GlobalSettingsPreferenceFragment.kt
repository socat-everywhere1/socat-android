...
class GlobalSettingsPreferenceFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val portLocalMiddleware  = findPreference<EditTextPreference>(Key.portLocalMiddleware )!!
        portLocalMiddleware.setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
        val portLocalDns = findPreference<EditTextPreference>(Key.portLocalDns)!!
        portLocalDns.setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
        val portLocalRaw  = findPreference<EditTextPreference>(Key.portLocalRaw )!!
        portLocalRaw.setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
        ...
        val listener: (BaseService.State) -> Unit = {
            ...
            portLocalMiddleware.isEnabled = stopped
            portLocalRaw.isEnabled = stopped
