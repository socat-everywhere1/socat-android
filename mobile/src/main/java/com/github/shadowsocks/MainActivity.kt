...
class MainActivity : AppCompatActivity(), ShadowsocksConnection.Callback, OnPreferenceDataStoreChangeListener,
    ...
    override fun onStart() {
        ...
        Log.i("socat","checking com.termux.permission")
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkPermission(this, "com.termux.permission.TERMUX_SERVICE")) {
                Log.i("socat","trying to get com.termux.permission")

                requestPermission(this, 0, "com.termux.permission.TERMUX_SERVICE");
            }
        }
