...
object DataStore : OnPreferenceDataStoreChangeListener {
    ...
    var portLocalDns: Int
        get() = getLocalPort(Key.portLocalDns, 7450)
        set(value) = publicStore.putString(Key.portLocalDns, value.toString())
    var portLocalMiddleware: Int
        get() = getLocalPort(Key.portLocalMiddleware, 7455)
        set(value) = publicStore.putString(Key.portLocalMiddleware, value.toString())
    var portLocalRaw: Int
        get() = getLocalPort(Key.portLocalRaw, 7454)
        set(value) = publicStore.putString(Key.portLocalRaw, value.toString())
    ...
    fun initGlobal() {
        ...
        if (publicStore.getString(Key.portLocalMiddleware) == null) portLocalMiddleware = portLocalMiddleware
        if (publicStore.getString(Key.portLocalRaw) == null) portLocalRaw = portLocalRaw
