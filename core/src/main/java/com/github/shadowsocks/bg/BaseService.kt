...
object BaseService {
    ...
    interface Interface {
        ...
        fun runTermuxScriptBackground(filePath: String) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ( this as Context).startForegroundService(intent)
            } else {
                ( this as Context).startService(intent)
            }
        }
        ...
        fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            data.connectingJob = GlobalScope.launch(Dispatchers.Main) {
                try {
                    ...
                    runTermuxScriptBackground("/data/data/com.termux/files/home/deinit.sh")
                } catch (exc: FileNotFoundException) {
                    stopRunner(false, "${getString(R.string.file_not_found)}: ${exc.readableMessage}") // restart=true for autorestarting
                    runTermuxScriptBackground("/data/data/com.termux/files/home/init.sh")
                } catch (exc: Throwable) {
